                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="border p-3 rounded">
                            <form class="row g-3" method="post" action="{{route('feature-title.store')}}" enctype="multipart/form-data">
                                @csrf
                                @method('post')
                                ...
                                <div class="col-12">
                                    ...
                                    <input class="form-control" type="text" name="name" id="name" placeholder="Features Name" required />
                                </div>
                                <div class="col-12">
                                    <label for="main_description" class="form-label">Features Description</label>
                                    <textarea class="form-control" name="main_description" id="main_description" placeholder="Features Description" required ></textarea>
                                </div>
