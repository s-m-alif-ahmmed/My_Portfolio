            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Add New Video Content</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="col-lg-8 mx-auto">
                <div class="card">
                    <div class="card-header py-3 bg-transparent">
                        <h5 class="mb-0">Add New Video Content</h5>
                    </div>
                    <div class="card-body">
                        <div class="border p-3 rounded">
                            <form class="row g-3" method="post" action="{{route('video.store')}}" enctype="multipart/form-data">
                                @csrf
                                @method('post')
                                ...
                                <div class="col-12">
                                    ...
                                    <input class="form-control" type="text" name="link" id="link" placeholder="Enter video link" required />
                                </div>
                                <div class="col-12">
