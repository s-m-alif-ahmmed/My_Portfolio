            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Add New Blog Content</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="col-lg-8 mx-auto">
                <div class="card">
                    <div class="card-header py-3 bg-transparent">
                        <h5 class="mb-0">Add New Blog Content</h5>
                    </div>
                    <div class="card-body">
                        <div class="border p-3 rounded">
                            <form class="row g-3" method="post" action="{{route('blog.store')}}" enctype="multipart/form-data">
                                ...
                                <div class="col-12">
                                    ...
                                    <input class="form-control" type="text" name="name" id="name" placeholder="Enter blog name" required />
                                </div>
                                <div class="col-12">
