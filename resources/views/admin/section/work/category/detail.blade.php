                        ...
                        <div class="card-body">
                            <table class="table table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <a href="{{route('category.edit', $category->id)}}" class="text-warning mx-2" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit"><i class="bi bi-pencil-fill"></i></a>
