                        ...
                        <div class="border p-3 rounded">
                            <form class="row g-3" method="post" action="{{route('client.update', $client->id)}}">
                                ...
                                <div class="col-12">
                                    ...
                                    <input class="form-control" type="text" name="heading" id="heading" placeholder="Heading Title" value="{{$client->heading}}" required />
                                </div>
                                <div class="col-12">
                                    <label for="name" class="form-label"> Name</label>
                                    <input class="form-control" type="text" name="name" id="name" placeholder=" Enter Name" value="{{$client->name}}" required />
                                </div>
