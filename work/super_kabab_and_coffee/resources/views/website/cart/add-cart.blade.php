                                            ...
                                            <div class="row">
                                                <div class="col float-start"></div>
                                                    ...
                                                    <!-- Calculate and display the total -->
                                                        ...
                                                        <form action="{{route('front.applyDiscount')}}" method="post">
                                                            @csrf
                                                            @method('post')
                                                            <div class="input-group input-group-md w-100 ms-auto py-3">
                                                                <input type="text" name="code" id="code" placeholder="Coupon Code" class="form-control">
                                                                <button class="btn btn-outline-danger" onclick="applyDiscount()" type="submit" id="applyDiscount">Apply Coupon</button>
                                                            </div>
                                                        </form>
        ...
        function applyDiscount() {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    // You can update the total or display messages accordingly.
                },
